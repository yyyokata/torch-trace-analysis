...
.dag-container { width: 100%; overflow: hidden; position: relative; contain: layout style; }
.dag-stage { display: block; margin: 0 auto; width: 100%; height: calc(100vh - 260px); min-height: 460px; overflow-x: hidden; overflow-y: auto; }
.dag-stage canvas { display: block; }
